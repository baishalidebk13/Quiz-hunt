...
import profilePhotoBaishali from './profile_photo_baishali.jpg'; // Make sure to replace this with the correct path

const testimonials = [
    {
        name: 'Baishali Deb Kanunjna',
        role: 'Full stack Web Developer',
        content: 'This quiz web app is built using React JS. It can allow the user to select the criteria for their quiz from a list of options. The user can then proceed to answer the questions in the quiz and their performance will be tracked and shown in the scoreboard. Moreover, the app can be designed to be responsive and user-friendly.',
        avatar: profilePhotoBaishali,
    }
];
